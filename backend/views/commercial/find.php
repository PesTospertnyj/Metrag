...
<?
$this->title = Yii::t('app', 'Commecial Search');
...
?>
    ...
    <div class="main-content">
        ...
        <?php $form = ActiveForm::begin([
            'method' => 'get',
            'action' => ['commercial/searchresult'],
            'layout' => 'horizontal',
            'fieldConfig' => [
        ...
        <div class="main-content-header">
            <div class="pull-left">
                <?= Yii::t('app', 'Commercials') ?>
            </div>
            <div class="pull-right">
                <?= Html::submitButton('Поиск', ['class' => 'btn btn-primary']) ?>
                <?//= Html::resetButton('Сбросить', ['class' => 'btn btn-default']) ?>
                <a href="<?= Url::base(true);?>/commercial/search" class="btn btn-default">Сбросить</a>
            </div>
            <div class="pull-right">
...
<!--                </div>-->
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                ...
                echo $form->field($model, 'type_object_id',[
                    ...
                    TypeObject::find()->select(['name', 'type_object_id'])->where(['type_realty_id'=>'6'])->indexBy('type_object_id')->column(),
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                ...
                echo $form->field($model, 'street',[
                    ...
                    ['' => '?'] +
                    \common\models\Commercial::find()->select('street')->distinct()->where(['>', 'LENGTH(street)', 0])->orderby('street')->indexBy('street')->column(), ['unselect' => null])->label('Улица');
                ?>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <?
                    echo $form->field($model, 'avtorampa', ['template' => "{label}<br>{input}", 'labelOptions' => ['class' => 'radio-btn-gp-label']])->radioList(['1' => \Yii::t('yii','Yes'), '2' => \Yii::t('yii','No'), '0' => \Yii::t('yii','All')])->label(\Yii::t('yii','State Act'));
                    ?>
                </div>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <?
                    echo $form->field($model, 'red_line', ['template' => "{label}<br>{input}", 'labelOptions' => ['class' => 'radio-btn-gp-label']])->radioList(['1' => \Yii::t('yii','Yes'), '2' => \Yii::t('yii','No'), '0' => \Yii::t('yii','All')])->label(\Yii::t('yii','Note'));
                    ?>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <?
                    echo $form->field($model, 'rent', ['template' => "{label}<br>{input}", 'labelOptions' => ['class' => 'radio-btn-gp-label']])->radioList(['1' => \Yii::t('yii','Yes'), '2' => \Yii::t('yii','No'), '0' => \Yii::t('yii','All')])->label(\Yii::t('yii','State Act'));
                    ?>
                </div>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <?
                    echo $form->field($model, 'detached_building', ['template' => "{label}<br>{input}", 'labelOptions' => ['class' => 'radio-btn-gp-label']])->radioList(['1' => \Yii::t('yii','Yes'), '2' => \Yii::t('yii','No'), '0' => \Yii::t('yii','All')])->label(\Yii::t('yii','Note'));
                    ?>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <?
                    echo $form->field($model, 'separate_entrance', ['template' => "{label}<br>{input}", 'labelOptions' => ['class' => 'radio-btn-gp-label']])->radioList(['1' => \Yii::t('yii','Yes'), '2' => \Yii::t('yii','No'), '0' => \Yii::t('yii','All')])->label(\Yii::t('yii','State Act'));
                    ?>
                </div>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <?
                    echo $form->field($model, 'housing', ['template' => "{label}<br>{input}", 'labelOptions' => ['class' => 'radio-btn-gp-label']])->radioList(['1' => \Yii::t('yii','Yes'), '2' => \Yii::t('yii','No'), '0' => \Yii::t('yii','All')])->label(\Yii::t('yii','Note'));
                    ?>
                </div>
            </div>
        </div>

...
?>
<?php
$url = explode('/admin/area/searchresult', Url::current());
$get = $url[1];
...
<div class="main-content">
    ...
    $gridColumns = [
        ...
        [
            'label' => 'Метро',
            'value' =>  function ($dataProvider) {
                return $dataProvider->metro->name;
            }
        ],
        [
    ...
    <div class="export">
        ...
        <a href="<?= Url::base(true);?>/area/search<?= $get;?>" class="btn btn-default">Вернуться к поиску</a>
        <a href="<?= Url::base(true);?>/area/print<?= $get;?>" class="btn btn-success" style="float: right;" target="_blank">Печать</a>

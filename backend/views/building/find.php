...
<!--            </div>-->
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
                echo $form->field($model, 'lived_complex_id',[
                    'template' => "{label} <br> <input id=\"street_search\" class=\"fast-search-input\"><div class=\"scrollbox\" style=\"height:174px;\">{input}</div>", 'labelOptions' => ['class' => '']])->checkboxList(
                    LivedComplex::find()->select(['name', 'id'])->orderby('name')->indexBy('id')->column())->label('ЖК');
                ?>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
                echo $form->field($model, 'street',[
                    'template' => "{label} <br> <input id=\"street_search\" class=\"fast-search-input\"><div class=\"scrollbox\" style=\"height:174px;\">{input}</div>", 'labelOptions' => ['class' => '']])->checkboxList(
                    ['' => '?'] +
                    \common\models\Building::find()->select('street')->distinct()->where(['>', 'LENGTH(street)', 0])->orderby('street')->indexBy('street')->column(), ['unselect' => null])->label('Улица');
                ?>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
                echo $form->field($model, 'condit_id',[
                    'template' => $scrollbox_template, 'labelOptions' => ['class' => '']])->checkboxList($statesOldSite)->label('Состояние');
                ?>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?

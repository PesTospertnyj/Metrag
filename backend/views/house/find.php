    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 ">
                ...
                <div class="col-xs-6 col-sm-2 col-md-1 ">
                    <label for="" class="from-to-label">Пл дома</label>
...
<!--                </div>-->
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                ...
                echo $form->field($model, 'street',[
                    ...
                    ['' => '?'] +
                    \common\models\House::find()->select('street')->distinct()->where(['>', 'LENGTH(street)', 0])->orderby('street')->indexBy('street')->column(), ['unselect' => null])->label('Улица');
                ?>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?

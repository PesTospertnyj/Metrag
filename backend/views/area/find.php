...
<?
$this->title = Yii::t('app', 'Area Search');
    ...
    <div class="main-content">
        ...
        <div class="main-content-header">
            ...
            <div class="pull-right">
                ...
                <a href="<?= Url::base(true);?>/area/search" class="btn btn-default">Сбросить</a>
            </div>
            <div class="pull-right">
...
<!--            </div>-->
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                ...
                echo $form->field($model, 'type_object_id',[
                    ...
                    TypeObject::find()->select(['name', 'type_object_id'])->where(['type_realty_id'=>'5'])->indexBy('type_object_id')->column(),
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                ...
                echo $form->field($model, 'street',[
                    ...
                    ['' => '?'] +
                    \common\models\Area::find()->select('street')->distinct()->where(['>', 'LENGTH(street)', 0])->orderby('street')->indexBy('street')->column(), ['unselect' => null])->label('Улица');
                ?>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
                echo $form->field($model, 'mediator_id',[
                    'template' => $scrollbox_template, 'labelOptions' => ['class' => '']])->checkboxList(
                    Mediator::find()->select(['name', 'mediator_id'])->orderby('name')->indexBy('mediator_id')->column())->label('Посредник');
                ?>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
                echo $form->field($model, 'partsite_id',[
                    'template' => $scrollbox_template, 'labelOptions' => ['class' => '']])->checkboxList(
                    Partsite::find()->select(['name', 'partsite_id'])->orderby('name')->indexBy('partsite_id')->column())->label('Часть участка');
                ?>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2">
                <?
            ...
            <div class="col-xs-1 col-sm-1 col-md-1">
                <?
                echo $form->field($model, 'state_act', ['template' => "{label}<br>{input}", 'labelOptions' => ['class' => 'radio-btn-gp-label']])->radioList(['1' => \Yii::t('yii','Yes'), '2' => \Yii::t('yii','No'), '0' => \Yii::t('yii','All')])->label(\Yii::t('yii','Exchange'));
                ?>
            </div>
            <div class="col-xs-1 col-sm-1 col-md-1">
                <?
            ...
            <div class="col-xs-1 col-sm-1 col-md-1">
                <?
                echo $form->field($model, 'electric', ['template' => "{label}<br>{input}", 'labelOptions' => ['class' => 'radio-btn-gp-label']])->radioList(['1' => \Yii::t('yii','Yes'), '2' => \Yii::t('yii','No'), '0' => \Yii::t('yii','All')])->label(\Yii::t('yii','Exchange'));
                ?>
            </div>

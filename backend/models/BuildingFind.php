...
class BuildingFind extends Building
{
    ...
    public function rules()
    {
        return [
            ...
            [['number_building', 'corps', 'number_apartment', 'exchange_formula', 'landmark', 'phone', 'comment', 'note', 'notesite', 'lived_complex_id', 'street'], 'safe'],
    ...
    public function search()
    {
        ...
        $query->andFilterWhere(['lived_complex_id' => $get['lived_complex_id']]);

...
class ApartmentSearch extends Apartment
{
    ...
    {
        return [
            [['id', 'count_room', 'floor', 'floor_all', 'city_or_region', 'locality_id', 'course_id', 'region_id',
                'exchange', 'source_info_id', 'metro_id', 'wc_id', 'count_balcony', 'count_balcony_glazed',
                'exclusive_user_id', 'phone_line', 'bath', 'update_photo_user_id', 'enabled'], 'integer'],
            [['condit_id', 'mediator_id', 'wall_material_id', 'author_id', 'layout_id',
                'region_kharkiv_id', 'street_id', 'update_author_id', 'region_kharkiv_admin_id',
                'type_object_id', 'number_building', 'corps', 'number_apartment', 'exchange_formula',
                'landmark', 'phone', 'comment', 'note', 'notesite', 'date_added', 'date_modified', 'date_modified_photo'], 'safe'],

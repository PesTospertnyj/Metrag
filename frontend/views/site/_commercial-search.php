    ...
    <div id="wrapper">
        <div class="breadcrumbs">
            <div class="content">
                ...
                <p><span><a href="/" title="">Главная</a></span> / <?php echo Yii::t('app', 'Commercials');?></p>
            </div>
        </div>
        <div class="filter">
            <div class="content">
                <div class="item-filtr">
                    ...
                    <div class="item-filtr-select">
                        <?= $form->field($model, 'type_object_id')->dropdownList(
                            TypeObject::find()->select(['name', 'type_object_id'])->where(['type_realty_id'=>'6'])
                    ...
                    <div class="item-filtr-select">
                        ...
                        <a href="commercial?view=grid">Сбросить</a>
                    </div>
...
<? $this->registerJs('
    $(document).ready(function () {
        ...
        function show_region(){
            var selectVal = $("input[name=\'CommercialSearch[location]\']:checked").val();
            if (selectVal == \'2\') {
        ...
        $(\'#commercialsearch-location\').change(show_region);
        ');

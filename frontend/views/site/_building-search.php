                ...
                <div class="item-filtr">
                    ...
                    <div class="item-filtr-select">
                        <?= $form->field($model, 'type_object_id')->dropdownList(
                            TypeObject::find()->select(['name', 'type_object_id'])->where(['type_realty_id'=>'3'])
                    ...
                    <div class="item-filtr-select">
                        ...
                        <a href="building?view=grid">Сбросить</a>
                    </div>
...
<? $this->registerJs('
    $(document).ready(function () {
        ...
        function show_region(){
            var selectVal = $("input[name=\'BuildingSearch[location]\']:checked").val();
            if (selectVal == \'2\') {
        ...
        $(\'#buildingsearch-location\').change(show_region);
        ');

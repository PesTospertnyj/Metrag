    ...
    <div id="wrapper">
        <div class="breadcrumbs">
            <div class="content">
                ...
                <p><span><a href="/" title="">Главная</a></span> / <?php echo Yii::t('app', 'Areas');?></p>
            </div>
        </div>
        <div class="filter">
            <div class="content">
                <div class="item-filtr">
                    ...
                    <div class="item-filtr-select">
                        <?= $form->field($model, 'type_object_id')->dropdownList(
                            TypeObject::find()->select(['name', 'type_object_id'])->where(['type_realty_id'=>'5'])
                    ...
                    <div class="item-filtr-select">
                        ...
                        <a href="area?view=grid">Сбросить</a>
                    </div>
...
<? $this->registerJs('
    $(document).ready(function () {
        ...
        function show_region(){
            var selectVal = $("input[name=\'AreaSearch[location]\']:checked").val();
            if (selectVal == \'2\') {
        ...
        $(\'#areasearch-location\').change(show_region);
        ');

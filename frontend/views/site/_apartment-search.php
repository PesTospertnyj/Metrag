...
<div id="wrapper">
    <div class="breadcrumbs">
        <div class="content">
            ...
            <p><span><a href="/" title="">Главная</a></span> / <?php echo Yii::t('app', 'Apartments');?></p>
        </div>
    </div>
    <div class="filter">
        <div class="content">
            <div class="item-filtr">
                ...
                <div class="item-filtr-select">
                    ...
                    TypeObject::find()->select(['name', 'type_object_id'])->where(['type_realty_id'=>'2'])
                ...
                <div class="item-filtr-select">
                    ...
                    <a href="apartment?view=grid">Сбросить</a>
                </div>
                    <?php ActiveForm::end(); ?>
...
<? $this->registerJs('
    $(document).ready(function () {
        ...
        function show_region(){
            var selectVal = $("input[name=\'ApartmentSearch[location]\']:checked").val();
            if (selectVal == \'2\') {
        ...
        $(\'#apartmentsearch-location\').change(show_region);
        ');

...
<header>
        ...
        <nav id="topnav" role="navigation">
              ...
              <?php
              if (!isset ($_GET['art'])) echo "<li class=\"current\"><a href=\"/\">".Yii::t('app', 'HOME')."</a></li>";
              ...
              if (isset ($_GET['art']))
              {
               ...
               echo "<ul>";
	               ...
	               echo "<li><a href=\"/site/for-owners\">".Yii::t('app', 'For owners')."</a></li>";
	               echo "<li><a href=\"/site/to-rent\">".Yii::t('app', 'To rent')."</a></li>";
	               echo "<li><a href=\"/site/valuation\">".Yii::t('app', 'Property valuation')."</a></li>";
               echo "</ul>";
              echo "</li>";
